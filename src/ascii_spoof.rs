/*
ASCII lookalike detection logic. Normalises input domains, scores similarity,
checks a curated most-phished list, and queries the local SQLite domain database
to return likely spoof candidates.
*/
use anyhow::Result;
